...
export default {
  ...
  data() {
    return {
      urlEdit: "http://20.185.36.96:9090/clothes/" + this.id,
      urlColors: "http://20.185.36.96:9090/colors",
      urlBrands: "http://20.185.36.96:9090/brands",
      image: "http://20.185.36.96:9090/image/",
      preview_image: "",
      image_name:"",
      selected_image:"",
      selected_brand:"",
  ...
  mounted() {
    fetch("http://20.185.36.96:9090/clothes")
      .then((res) => res.json())
